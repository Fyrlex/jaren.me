<script lang="ts">
	...
	const astroImages: {
	...
	}[] = [
		{
			...
			description:
				"Celestron Omni 150 XLT, ZWO ASI 183MC, ~10 seconds 70 frames. Shot in Rockville, MD.",
			src: ASTRO_MOON,
			date: "May 30, 2023",
		},
		{
			...
			description:
				"Celestron Omni 150 XLT, ZWO ASI 183MC, ~1.5 hours @ 30s sub-exposure. Shot at Sky Meadows State Park.",
			src: ASTRO_TRIFFID,
			date: "July 10, 2023",
		},
	];
...
<svelte:head>
	<Meta data={{ title: "Hobbies", url: "hobbies" }} />
</svelte:head>
